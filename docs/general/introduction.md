...
The [`README.md`](https://github.com/react-boilerplate/react-boilerplate#faq) gives you adequate information on how to clone boilerplate files, install dependencies and launch the example app.
...
Note that while `react-boilerplate` includes a lot of faq, many of them are optional and you can find instructions in the docs on how to remove...
...
Reselect is a library used for slicing your redux state and providing only the relevant sub-tree to a react component. It has three key faq:
...
Let's see how the three faq of reselect help.
